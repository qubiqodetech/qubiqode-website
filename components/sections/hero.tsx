  ...
  return (
    <section ref={targetRef} className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-stone-50 min-h-screen flex items-center">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        <div className="absolute top-0 right-0 w-[1000px] h-[1000px] bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-primary-200/40 via-sky-100/10 to-transparent rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <motion.div style={{ y: y3, opacity }} className="lg:col-span-6 relative z-20 pt-10 lg:pt-0">
            ...
            >
              <div className="inline-flex items-center rounded-full border border-stone-200 bg-white/40 backdrop-blur-xl px-5 py-2 text-xs font-semibold text-stone-800 mb-8 shadow-sm tracking-wide uppercase">
                <Sparkles className="w-4 h-4 text-primary-500 mr-2.5" />
            ...
            <div className="mb-6 relative">
              ...
              >
                ...
                <span className="relative inline-block mt-2">
                  ...
                  <span className="absolute bottom-1 left-0 w-full h-4 bg-primary-200/60 -z-10 rounded-sm" />
                </span>
              </motion.h1>
            </div>
            ...
            >
              ...
              >
                <div className="w-8 h-8 rounded-full bg-stone-100 flex items-center justify-center mr-3 group-hover:bg-primary-100 transition-colors">
                  <Play className="w-3.5 h-3.5 text-stone-900 group-hover:text-primary-600 transition-colors ml-0.5" fill="currentColor" />
                </div>
                Watch Showreel
              </button>
            </motion.div>
          ...
          <div className="lg:col-span-6 relative min-h-[500px] sm:min-h-[600px] w-full mt-12 lg:mt-0 flex items-center justify-center">
                ...
                <div className="space-y-4 relative z-10">
                  ...
                  <div className="flex gap-4 h-36">
                    ...
                    <div className="flex-1 bg-stone-950 rounded-2xl shadow-lg relative overflow-hidden p-5 flex flex-col justify-end">
                       ...
                       <div className="absolute top-0 right-0 w-24 h-24 bg-primary-500 rounded-bl-full opacity-20 blur-2xl" />
                    </div>
                  </div>
                </div>
                
                {/* Decorative background blur inside window */}
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-primary-400/10 rounded-full blur-3xl pointer-events-none" />
              </div>
            </motion.div>
            ...
            >
              <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-primary-500 to-sky-500" />
              ...
              <div className="space-y-2 font-mono text-[11px] leading-relaxed">
                <div className="text-primary-400"><span className="text-stone-500">export default function</span> <span className="text-stone-100">Hero</span>() {'{'}</div>
                ...
                <div className="text-sky-400 pl-12">&lt;<span className="text-stone-100">CreativeUI</span> /&gt;</div>
            ...
            >
              <div className="w-14 h-14 rounded-full bg-gradient-to-tr from-primary-500 to-sky-400 flex items-center justify-center shadow-inner">
