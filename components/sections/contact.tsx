...
export function Contact() {
  return (
    <section
      id="contact"
      className="py-24 bg-stone-900 border-t border-stone-800 text-white relative overflow-hidden"
    >
      {/* Background glow */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div>
              ...
              <p className="text-lg text-stone-400 mb-10 max-w-md">
                ...
                explore possibilities, we're ready to help.
              </p>
              ...
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <input
                      id="firstName"
                      type="text"
                      className="w-full bg-stone-900 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-orange-500 transition-all"
                      required
                    />
                  </div>
                  <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    id="message"
                    rows={4}
                    className="w-full bg-stone-900 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-orange-500 transition-all resize-none"
                    required
                  ></textarea>
                </div>
                <button
                  type="submit"
                  className="w-full bg-orange-600 hover:bg-orange-500 text-white rounded-xl px-4 py-4 font-semibold flex items-center justify-center gap-2 transition-colors"
                >
                  Send Message
