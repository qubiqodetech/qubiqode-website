...
const processSteps = [
  ...
  {
    icon: <Bug className="w-8 h-8 text-primary-500" />,
  ...
  {
    icon: <LifeBuoy className="w-8 h-8 text-primary-500" />,
    ...
    <main className="min-h-screen bg-stone-50 selection:bg-primary-200">
      ...
      <section className="pt-32 pb-20 lg:pt-48 lg:pb-32 bg-stone-950 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 max-w-7xl relative z-10 text-center">
          ...
          >
            A proven framework for <span className="text-primary-500 italic">digital success.</span>
          </motion.h1>
          ...
          <div className="space-y-16 md:space-y-32">
            {processSteps.map((step, idx) => {
              ...
              return (
                ...
                >
                  {/* Center Node/Marker */}
                  <div className="absolute left-0 md:left-1/2 -ml-2.5 md:-ml-3 w-5 h-5 md:w-6 md:h-6 rounded-full border-4 border-white bg-stone-300 shadow-sm z-10 group-hover:bg-primary-500 transition-colors duration-500" />
                  ...
                  <div className={`w-full md:w-1/2 pl-12 md:pl-0 ${isEven ? 'md:pr-16 md:text-right' : 'md:pl-16 md:ml-auto'}`}>
                    <div className="bg-white p-8 md:p-10 rounded-[2rem] border border-stone-200 shadow-sm hover:shadow-xl hover:border-primary-200 transition-all duration-300 relative overflow-hidden">
                      <div className={`absolute top-0 w-full h-1 bg-gradient-to-r from-primary-400 to-primary-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300 ${isEven ? 'right-0' : 'left-0'}`} />
                      
                      <div className={`mb-6 p-4 bg-primary-50 rounded-2xl inline-block ${isEven ? 'md:float-right md:ml-6' : ''}`}>
                         {step.icon}
                      </div>
                      
                      <div className="clear-both">
                        <div className="text-primary-500 font-mono font-bold text-sm mb-2">Phase 0{idx + 1}</div>
         ...
         <div className="container mx-auto px-6 max-w-7xl">
           ...
           >
             <div className="max-w-3xl mx-auto">
               ...
               <Link
                 href="/contact"
                 className="inline-flex items-center justify-center rounded-full bg-primary-600 px-8 py-4 text-sm font-semibold text-white shadow-[0_0_20px_rgba(30,144,255,0.3)] hover:bg-primary-500 transition-all duration-300"
               >
                 Start Your Project
